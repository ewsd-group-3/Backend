...
import { newIdeaEmail } from '../../types/response';

const emailTemplate = async (data: newIdeaEmail) => {
  const author = await prisma.staff.findUnique({ where: { id: data.idea.authorId } });
  const createdAt = new Date(data.idea.createdAt);
              ...
              <div class="u-row-container" style="padding: 0px; background-color: transparent">
                ...
                >
                  <div style="border-collapse: collapse; display: table; width: 100%; height: 100%; background-color: transparent">
                    ...
                    <!--[if (mso)|(IE)]><td align="center" width="640" style="background-color: #ffffff;width: 640px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
                    <div class="u-col u-col-100" style="max-width: 320px; min-width: 640px; display: table-cell; vertical-align: top">
                      <div
                        style="
                                ...
                                >
                                  <div>
                                    <div style="padding: 10px 40px 40px">
                                      <h1 style="font-size: 28px; margin-bottom: 8px">You have 1 new idea to view.</h1>
                                      <p style="font-size: 14px; margin-bottom: 12px">Hi ${data.receiver.name},</p>
                                      <p style="font-size: 14px; line-height: 1.6; margin-bottom: 10px">
                                        A new idea is submitted from your department.
                                      </p>
                                      <div style="background-color: #fafafa; margin-top: 32px; padding: 8px 20px; border-radius: 8px 8px 0px 0px">
                                        <table style="width: 100%; table-layout: fixed">
                                          <tbody>
                                            <tr>
                                              <td style="font-size: 14px; color: #787878; padding: 8px 0">Title</td>
                                              <td style="font-size: 14px; padding: 8px 0">${data.idea.title}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td style="font-size: 14px; padding: 8px 0">${data.idea.isAnonymous ? 'Anonymous' : author?.name}</td>
                                            </tr>
                                            <tr>
                                              <td style="font-size: 14px; color: #787878; padding: 8px 0">Created on</td>
                                              <td style="font-size: 14px; padding: 8px 0">${createdAt.toDateString()}</td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </div>
                                    ...
                                    <div style="background-color: #e6e6e6; height: 1px"></div>
  
                                    <p style="font-size: 14px; margin-top: 20px; margin-left: 12px">This is an automated email. Please do not reply.</p>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
